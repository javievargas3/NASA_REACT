...
import Digits from '../../assets/images/image.jpeg';
        ...
        <div className={`${classes.row} ${classes.navbar} ${classes.width100} ${classes.alignCenter} ${classes.p5} ${classes.spaceBetween}`}>
            ...
            <div className={`${classes.width60} ${classes.alignCenter}`}>
                <ul className={`${classes.ul} ${classes.row} ${classes.spaceBetween} ${classes.psides}`}>
                    ...
                    <li>
                        <Button>
                        <Link to='/signIn' className={`${classes.navbarItem} ${classes.psides}`}>Create an Account</Link>
                        </Button>
                    </li>
                
                    <li>
                        <Button>
                            <Link to='Search' className={`${classes.navbarItem} ${classes.psides}`}>Search For Image</Link>
                        </Button>
                    </li>
                    <li>
                        <Button>
                    ...
                    <li>
                        <Button>
                            <Link to='Notes' className={`${classes.navbarItem} ${classes.psides}`}>My Notes</Link>
                        </Button>
                    </li>
                </ul> 
            </div>
